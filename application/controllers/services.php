...
class Services extends Public_Controller
{
    ...
    public function view()
    {
        ...
        $this->data["services"] = $services =  $this->service_model->get_service_list($where, FALSE);


        $this->data['pageTitle'] = "Darewro Services";
        $this->data['pageDescription'] = "We offer a wide range of services to our clients. We are here to help you with your business needs.";
        foreach ($services as $service) {
            $this->data['pageKeywords'] .= $service->service_title . ", ";
        }
        $this->data['pageKeywords'] = rtrim($this->data['pageKeywords'], ", ");
