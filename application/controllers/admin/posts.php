...
class Posts extends Admin_Controller{
    ...
    /**
     ...
     public function add(){
        ...
        $this->data["title"] = $this->lang->line('Add New Post');$this->data["view"] = ADMIN_DIR."posts/add_post";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
     ...
     public function edit($post_id){
        ...
        $this->data["title"] = $this->lang->line('Edit Post');$this->data["view"] = ADMIN_DIR."posts/edit_post";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
