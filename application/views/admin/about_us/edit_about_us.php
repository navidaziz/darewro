    ...
    <div class="col-md-12">
        <div class="box border blue" id="messenger">
            ...
            <div class="box-body">
                ...
                echo form_open_multipart(ADMIN_DIR . "about_us/update_data/$about_us->about_us_page_id", $edit_form_attr);
                ?>
                <?php echo form_hidden("about_us_page_id", $about_us->about_us_page_id); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "value"         =>  set_value("about_us_page_title", $about_us->about_us_page_title),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "value"         =>  set_value("about_us_page_description", $about_us->about_us_page_description),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "value"         =>  set_value("about_us_page_keyword", $about_us->about_us_page_keyword),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "value"         =>  set_value("about_us_page_content", $about_us->about_us_page_content),
                ...
                <div class="form-group">
                    ...
                    echo form_label($this->lang->line('image') . "<br />" . file_type(base_url("assets/uploads/" . $about_us->image)), "image", $label);     ?>
                    ...
                    <div class="col-md-8">
                        ...
                        $file = array(
                            ...
                            "value"         =>  set_value("image", $about_us->image),
                            "placeholder"   =>  $this->lang->line('image')
                        );
                        echo  form_input($file);
                        ?>
                        <!--<?php echo file_type(base_url("assets/uploads/$about_us->image")); ?>-->
