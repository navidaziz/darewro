        ...
        <div class="box border blue" id="messenger">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="radio" name="post_type" value="Image" id="post_type" style="" required="required" onclick="$('#videolink').hide(); $('#videolink').prop( 'disabled', true ); $('#ImageFile').show(); $('#ImageFile').prop( 'disabled', false );" class="uniform" 0="Array">
                        <label for="post_type" style="margin-left:10px;">Image</label><br>
                        <input type="radio" name="post_type" value="Video" id="post_type" style="" required="required" onclick="$('#videolink').show(); $('#videolink').prop( 'disabled', true ); $('#ImageFile').hide(); $('#ImageFile').prop( 'disabled', false );" class="uniform" 0="Array"><label for="post_type" style="margin-left:10px;">Video</label><br>
                    </div>
                </div>

                <div class="form-group" style="display: none;" id="ImageFile">
